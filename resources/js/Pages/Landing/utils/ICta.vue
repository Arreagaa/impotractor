<template>
    ...
    <div class="max-w-full flex justify-center items-center">
        <card class="card grid grid-cols-6 w-full p-8 bg-zinc-900">
            <div class="col-span-4">
                <h2 class="font-bold text-3xl text-white ml-10 mt-8">
                    ¿Necesitas Asesoría?
                </h2>

                <p class="font-light text-white text-xl ml-10 mt-5">
                    En caso que tengas alguna duda o pregunta en particular, solamente márcanos, y con mucho gusto te responderemos.
                </p>
