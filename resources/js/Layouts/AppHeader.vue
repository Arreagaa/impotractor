...
<template>
<div class="max-w-fill bg-zinc-900 text-white work-sans leading-normal text-base tracking-normal">
    <!--Nav-->
    <nav id="header" class="w-full z-30 top-0 py-1">
        <div class="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 px-6 py-3">
            ...
            <div class="hidden md:flex md:items-center md:w-auto w-full order-3 md:order-1" id="menu">
                ...
                <nav class="lg:hidden">
                    <ul class="md:flex items-center justify-between text-base text-white pt-8 md:pt-0">
                        ...
                        <li><a class="inline-block no-underline py-2 px-4 hover:text-yellow-300" href="#">PRODUCTOS</a></li>
                        <li><a class="inline-block no-underline py-2 px-4 hover:text-yellow-300" href="#">CONTACTO</a></li>
                        <li><a class="inline-block no-underline py-2 px-4 hover:text-yellow-300" href="#">INICIAR SESIÓN</a></li>
                    </ul>
                </nav>
            </div>
            ...
            <div class="order-2 md:order-3 flex items-center lg:block hidden" id="nav-content">
                ...
                <a class="inline-block no-underline hover:text-yellow-300" href="#">
                    <a class="inline-block no-underline py-2 px-4 hover:text-yellow-300" :href="route('register')">INICIAR SESIÓN</a>
                </a>

            </div>

            <div  class="order-2 md:order-3 flex items-center lg:hidden" id="nav-content">
                <!--<a class="inline-block no-underline hover:text-yellow-300 lg:hidden" href="#">
                    <svg class="fill-current hover:text-yellow-300" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                        <circle fill="none" cx="12" cy="7" r="3" />
                        <path d="M12 2C9.243 2 7 4.243 7 7s2.243 5 5 5 5-2.243 5-5S14.757 2 12 2zM12 10c-1.654 0-3-1.346-3-3s1.346-3 3-3 3 1.346 3 3S13.654 10 12 10zM21 21v-1c0-3.859-3.141-7-7-7h-4c-3.86 0-7 3.141-7 7v1h2v-1c0-2.757 2.243-5 5-5h4c2.757 0 5 2.243 5 5v1H21z" />
                    </svg>
                </a>

                <a class="pl-3 inline-block no-underline hover:text-yellow-300 lg:hidden" href="#">
                    <svg class="fill-current hover:text-yellow-300" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
