                ...
                <div class="w-full lg:w-1/2 xl:w-6/12 px-4">
                    <div class="max-w-[570px] mb-12 lg:mb-0">
                        ...
                        <div class="flex mb-8 max-w-[370px] w-full">
                            <div
                                class="max-w-[60px] sm:max-w-[70px] w-full h-[60px] sm:h-[70px] flex items-center justify-center mr-6 overflow-hidden bg-opacity-5 text-primary rounded"
                            >
                                <svg
                                    fill="none"
                                    stroke="currentColor"
                        ...
                        <div class="flex mb-8 max-w-[370px] w-full">
                            ...
                            >
                                <svg
                                    ...
                                    height="26"
                                    viewBox="0 0 24 26"
                                    class="fill-current w-8 h-8 text-zinc-900"
                                >
                                    <path
