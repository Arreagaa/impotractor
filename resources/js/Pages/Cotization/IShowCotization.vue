...
<template>
            ...
            >
              <thead class="text-white">
                <tr
                  ...
                  "
                >
                  <th class="p-3 text-left">Número de Parte</th>
                  <th class="p-3 text-left">Cantidad</th>
                  <th class="p-3 text-left">Descripción</th>
                  <th class="p-3 text-left">Peso neto (Lb)</th>
  ...
  <div class="pt-4 px-4" id="Resumen">
    <div class="my-4">
      <div class="bg-white shadow rounded-lg mb-4 p-4 sm:p-6 h-full">
        <div class="flex items-center justify-between mb-4">
          <h3 class="text-xl font-bold leading-none text-gray-900">Resumen</h3>
        </div>
        <div class="flex items-center justify-center">
          <div class="container lg:block hidden">
            <table
              ...
              "
            >
              <thead class="w-full data overflow-hidden bg-white text-zinc-900">
                <tr>
                  <th colspan="3" class="p-2 border">Información Importante</th>
                  <th colspan="2" class="p-2 border">Precio a (35%)</th>
                  <th colspan="2" class="p-2 border">Precio a (30%)</th>
                  <th colspan="2" class="p-2 border">Precio a (25%)</th>
                  <th colspan="3" class="p-2 border">Precio Final</th>
                </tr>
              </thead>
            ...
            >
              <thead class="text-white">
                ...
                >
                  ...
                  <th class="p-3 text-left">Cantidad</th>
                  <th class="p-3 text-left">Descripción</th>
                  <th class="p-3 text-left">P. Unitario (35%)</th>
                  <th class="p-3 text-left">Total (35%)</th>
                  <th class="p-3 text-left">P. Unitario (30%)</th>
                  <th class="p-3 text-left">Total (30%)</th>
                  <th class="p-3 text-left">P. Unitario (25%)</th>
                  <th class="p-3 text-left">Total (25%)</th>
                  <th class="p-3 text-left">Porcentaje Final</th>
                  <th class="p-3 text-left">Unitario Final</th>
