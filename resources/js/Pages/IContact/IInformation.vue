<template>
    <div class="flex mb-8 max-w-[370px] w-full">
        ...
        <div class="w-full">
            <h4 class="font-bold text-dark text-xl mb-1">Nuestra Ubicación</h4>
            <p class="text-base text-body-color">
                Calzada Raúl Aguilar Batres 7-18 zona 11, Ciudad de Guatemala.
            </p>
        </div>
    </div>
    <div class="flex mb-8 max-w-[370px] w-full">
        ...
        <div class="w-full">
            <h4 class="font-bold text-dark text-xl mb-1">Comunícate</h4>
            <p class="text-base text-body-color">
    ...
    <div class="flex mb-8 max-w-[370px] w-full">
        ...
        <div class="w-full">
            <h4 class="font-bold text-dark text-xl mb-1">Correo Electrónico</h4>
            <p class="text-base text-body-color">
