...
<template>
    <div>
        ...
        <div class="min-h-screen bg-gray-100">
            <nav class="bg-zinc-900 border-b border-gray-100">
                                ...
                                <Dropdown align="right" width="48">
                                    <template #trigger>
                                        ...
                                        >
                                            <button
                                                type="button"
                                                class="inline-flex items-center px-3 py-2 border border-transparent text-base leading-4 font-bold rounded-md text-white hover:text-yellow-400 focus:outline-none transition"
                                            >
